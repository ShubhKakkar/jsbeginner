...
function fromProjectPath_(projectRoot, p) {
  ...
  let projectPath = process.platform === 'win32' ? _path().default.normalize(p) : p; // Add separator if needed. Doing this manunally is much faster than path.join.
